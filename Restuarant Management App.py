...
class RestauarantOrderManagement:
    def __init__(self, root):
       ...
       ttk.Label(
           frame, text="Rsturant Order Management ", font=("Arial",20, "bold")
       ...
       for i, (item, price) in enumerate(self.menu_items.items(), start=1):
           ...
           def setup_background(self, root):
               ...
               canvas.create_image = background_image
           ...
           def place_order(self):
               ...
               if total_cost > 0:
                   ...
                   messagebox.showerror("Eror", "Please order at least one item.")
if __name__ == " __main__":
    root = tk.Tk()
    app = RestauarantOrderManagement(root)
